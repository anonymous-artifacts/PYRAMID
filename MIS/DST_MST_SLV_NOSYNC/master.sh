#!/bin/bash
# pyramid/MIS/DST_MST_SLV_NOSYNC/master.sh — Run DST_MST_SLV_NOSYNC MIS experiments
...
echo "============================================="
echo "  MIS DST_MST_SLV_NOSYNC Experiment Runner"
echo "  $(date)"
echo "  Threads: ${NUM_THREADS}, Partitions: ${NUM_PARTITIONS}"
echo "  DPU offload: BFS + Clustering"
echo "  Sync mode: NONE"
echo "============================================="
