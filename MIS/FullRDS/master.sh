#!/bin/bash
# pyramid/MIS/FullRDS/master.sh — Run FullRDS_MIS across all datasets and batch ratios
# Phase 1 (BFS) + Phase 2 (Clustering) on DPU, Phase 3 (MIS Update) on CPU
...
BINARY="${SCRIPT_DIR}/FullRDS_MIS_host"
...
echo "============================================="
echo "  MIS FullRDS Experiment Runner"
echo "  $(date)"
