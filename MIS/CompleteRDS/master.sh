#!/bin/bash
# pyramid/MIS/CompleteRDS/master.sh — Run CompleteRDS_MIS across all datasets and batch ratios
# ALL phases (BFS + Clustering + MIS Update) on DPU, host only reads batches + verifies
...
DPU_PORT="${DPU_PORT:-5004}"

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
BINARY="${SCRIPT_DIR}/CompleteRDS_MIS_host"
...
echo "============================================="
echo "  MIS CompleteRDS (Full Offload) Runner"
echo "  $(date)"
