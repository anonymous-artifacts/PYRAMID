#!/bin/bash
# pyramid/GC/PartialRDS/master.sh — Run PartialRDS_GC across all datasets and batch ratios
# Phase 1 (ProcessCE) runs on DPU, Phases 2+3 on CPU
...
DPU_PORT="${DPU_PORT:-5001}"

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
BINARY="${SCRIPT_DIR}/PartialRDS_GC_host"
...
echo "============================================="
echo "  GC PartialRDS Experiment Runner"
echo "  $(date)"
