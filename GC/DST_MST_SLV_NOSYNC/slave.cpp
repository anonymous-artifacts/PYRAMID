/*
 * slave.cpp - Slave node for DST_MST_SLV_NOSYNC Graph Coloring Pipeline
 *
 * NO-SYNC variant: does local GC update (P3) and sends deltas to master.
...
struct DpuGcResult {
    ...
    vector<ColorChange> color_changes;
